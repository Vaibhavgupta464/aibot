...
source_option = st.radio("Choose how to provide job data:", ["Upload HTML", "Enter Job Link"])
...
"""
    ...
    selected_link = st.text_input("Paste the direct job link here")
...
**Generated by:** [Vaibhav Gupta](https://www.linkedin.com/in/vaibhav-gupta-897096140/)  
*AI Resume Generator built using OpenAI and Streamlit*
"""
